...
export const es = {
  ...
  strategy: {
    ...
    tooltipStrategy:
      "Motor de lógica en tiempo real. Compara las comisiones actuales vs. el historial de 100 bloques. El modo 'Paciente' sugiere esperar durante picos; el modo 'Fiable' prioriza la velocidad de confirmación.",
